...
var BlackDuckCheck_1 = require("./services/BlackDuckCheck");
function run() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 8, , 9]);
                    bdUrl = core.getInput('blackduck-url', { required: false }) || 'allegion.blackducksoftware.com';
                    bdToken = core.getInput('blackduck-token', { required: true });
                ...
                case 1:
                    ...
                    if (!failOnLicenseSelection) return [3, 3];
                    return [4, blackduckCheck.failOnLicenseRisks(blackDuckData, licenseList)];
                case 2:
                    ...
                    _a.label = 3;
                case 3:
                    failOnSecuritySelection = core.getBooleanInput('fail-on-security-risks', { required: false });
                    securityExclusionList = core.getInput('security-exclusions', { required: false });
                    securityList = securityExclusionList === '' ? [] : securityExclusionList.split(', ');
                    if (!failOnSecuritySelection) return [3, 5];
                    return [4, blackduckCheck.failOnSecurityRisks(blackDuckData, securityList)];
                case 4:
                    ...
                    _a.label = 5;
                case 5:
                    failOnPolicySelection = core.getBooleanInput('fail-on-policy-violations', { required: false });
                    policyExclusionList = core.getInput('policy-exclusions', { required: false });
                    policyList = policyExclusionList === '' ? [] : policyExclusionList.split(', ');
                    if (!failOnPolicySelection) return [3, 7];
                    return [4, blackduckCheck.failOnPolicyViolations(blackDuckData, policyList)];
                case 6:
                    policyCheck = _a.sent();
